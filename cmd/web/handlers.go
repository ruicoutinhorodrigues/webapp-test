...
func (app *application) Login(w http.ResponseWriter, r *http.Request) {
	...
	if !app.authenticate(r, user, password) {
		app.Session.Put(r.Context(), "error", "Invalid login. Wrong password!")
...
func (app *application) UploadProfilePic(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := os.Stat(fmt.Sprintf("./static/img/%s", user.ProfilePic.FileName)); err == nil {
		os.Remove(fmt.Sprintf("./static/img/%s", user.ProfilePic.FileName))
	}
